...
export class Item extends MyObject3D {
  ...
  protected _update():void {
    ...
    this._baseSize.x = this._baseSize.y = Util.instance.mix(1, 1.1, this._hoverRate) * Func.instance.val(3, 1)
    ...
    size *= Util.instance.mix(1, 1.5, this._hoverRate)
