...
export class hoverHeart extends MyObject3D {
  ...
  public show():void {
    ...
    this._tgPos.x = Util.instance.range(2) * Func.instance.val(2, 1)
    this._tgPos.y = Util.instance.range(2)
    this._movePos.x = 0
    this._movePos.y = 0
  }
  ...
  protected _update():void {
    ...
    if(this.isShow) {
      ...
      const r = Util.instance.mix(20, 50, this._noise) * 2
